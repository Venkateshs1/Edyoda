...
class admin:
    ...
    food_item_list={1:{'Name' : 'Tandoori Chicken' , 'Quantity' : '4 piece' , 'Price' : 240 , 'Discount(%)' : 15,"Stock" : 50}, 2:{'Name' : 'Vegan Burger' , 'Quantity' : '1 piece' , 'Price' : 320 , 'Discount(%)' : 20,"Stock" :45}, 3:{'Name' : 'Truffle Cake' , 'Quantity' : '500 gms' , 'Price' : 900 , 'Discount(%)' : 25, "Stock" :40}}
    user_details = {}
    user_login=[]
    admin_details = {}
    count=5
    ...
    def __init__(self):
            print("Yummy- Online Food Delivery")
...
# Adding New Food Items by Admin
...
# Placing Food Order from List of Food Items
    def new_order(self):
...
# Viewing Order History of the Logged in User
...
# Viewing the options to place a new order /Order History / Updating User Profile of Logged in User
...
# Function to generate cost of Selected Food Items
    def cost_gen(self):
        self.sum = 0
        for i in self.order_action:
...
# Bill Generation after Successful Placement of order    
    def bill_gen(self):
